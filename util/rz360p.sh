...
VIDEO_PARAMS="-pix_fmt yuv420p -vf scale=-1:360 -c:v libx264 -profile:v high -preset slow -crf 23 -r 24000/1001 -bf 2"
# VIDEO_PARAMS="-pix_fmt yuv420p -vf scale=-1:360 -c:v libx264 -profile:v high -preset slow -crf 23 -r 30000/1001 -bf 2"
