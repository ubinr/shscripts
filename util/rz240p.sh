...
#AUDIO_PARAMS="-c:a $AAC_ENCODER -profile:a aac_low -b:a 96k"
VIDEO_PARAMS="-pix_fmt yuv420p -vf scale=-1:240 -c:v libx264 -profile:v high -preset slow -crf 23 -r 24000/1001 -bf 2"
